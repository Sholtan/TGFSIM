...
void TGFElectricFieldSetup::UpdateIntegrator()
{
  ...
  G4cout<< " TGFElectricFieldSetup: The minimal step is equal to "
...
G4ElectricField* TGFElectricFieldSetup::GetField()
{
  return fEMfield;
}
...
void TGFElectricFieldSetup::CreateStepper()
{
...
void TGFElectricFieldSetup::SetFieldZValue(G4double fieldValue)
{
...
void TGFElectricFieldSetup::SetFieldValue(G4ThreeVector fieldVector)
{
...
G4FieldManager*  TGFElectricFieldSetup::GetGlobalFieldManager()
{
//  Utility method
