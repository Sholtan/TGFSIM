...
#ifndef TGFElectricFieldSetup_HH
#define TGFElectricFieldSetup_HH 1
...
{
public:
  TGFElectricFieldSetup(G4ThreeVector);  //  The value of the field
  TGFElectricFieldSetup();               //  A zero field - true value set later

  virtual ~TGFElectricFieldSetup();
